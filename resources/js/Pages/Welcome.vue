 ...
 * @property {boolean} canLogin – A felhasználó bejelentkezhet-e.
 * @property {boolean} canRegister – A felhasználó regisztrálhat-e.
 * @property {string} laravelVersion – A Laravel verziója.
 * @property {string} phpVersion – A PHP verziója.
 */
...
const props = defineProps({
    /**
     * A felhasználó bejelentkezhet-e.
     *
     * @type {boolean}
     */
    canLogin: {
