<template>
    <div class="relative" @mouseover="showMenu" @mouseleave="hideMenu">
        <a href="/#features" class="text-copy-primary hover:text-gray-600" @focus="showMenu"
        ...
        <transition name="mega-menu-fade">
            <div v-show="isVisible"
                    ...
                    <ul class="w-full lg:w-1/2 px-4">
                        <li class="mb-8">
                            <a href="#" class="flex group" @keydown.esc.exact="hideMenu"
                                ...
                                <svg fill="currentColor" class="text-blue-500 group-hover:text-blue-800"
                                ...
                                <span class="ml-2">
                                    <span
                                        ...
                                        <span
                                            class="ml-2 bg-yellow-500 text-yellow-800 px-2 py-1 rounded-full uppercase font-bold text-xxs">New</span>
                                    </span>
                                    <span class="block text-sm text-gray-600 group-hover:text-blue-800">Measure actions
                                        users take</span>
                                </span>
                            </a>
                        </li>
                        <li class="mb-8">
                            <a href="#" class="flex group" @keydown.esc.exact="hideMenu"
                                @keydown.tab.exact="focusNext(false)" @keydown.shift.tab="focusPrevious(false)"
                                ...
                                <span class="ml-2">
                                    <span class="block font-bold text-blue-800 group-hover:text-blue-800">Test Missle
                                        Alert</span>
                                    <span class="block text-sm text-gray-600 group-hover:text-blue-800">Probably meant
                                        to click this one</span>
                                </span>
                            </a>
                        </li>
                        <li class="mb-8 lg:mb-0">
                            <a href="#" class="flex group" @keydown.esc.exact="hideMenu"
                                ...
                                <span class="ml-2">
                                    <span
                                        class="block font-bold text-blue-800 group-hover:text-blue-800">Automations</span>
                                    <span class="block text-sm text-gray-600 group-hover:text-blue-800">Create your own
                                        custom rules</span>
                                </span>
                            </a>
                        </li>
                    ...
                    <ul class="w-full lg:w-1/2 px-4">
                        <li class="mb-8">
                            <a href="#" class="flex group" @keydown.esc.exact="hideMenu"
                                ...
                                <span class="ml-2">
                                    <span
                                        class="block font-bold text-blue-800 group-hover:text-blue-800">Notifications</span>
                                    <span class="block text-sm text-gray-600 group-hover:text-blue-800">Keep customers
                                        informed</span>
                                </span>
                            </a>
                        </li>
                        <li class="mb-8">
                            <a href="#" class="flex group" @keydown.esc.exact="hideMenu"
                                ...
                                <span class="ml-2">
                                    <span class="block font-bold text-blue-800 group-hover:text-blue-800">Missle
                                        Alert</span>
                                    <span class="block text-sm text-gray-600 group-hover:text-blue-800">Cause widespread
                                        panic</span>
                                </span>
                            </a>
                        </li>
                        <li class="">
                            <a href="#" class="flex group" @keydown.esc.exact="hideMenu"
                                ...
                                <span class="ml-2">
                                    <span class="block font-bold text-blue-800 group-hover:text-blue-800">Advanced
                                        Reports</span>
                                    <span class="block text-sm text-gray-600 group-hover:text-blue-800">Keep track of
                                        your growth</span>
                                </span>
                            </a>
                        </li>
                ...
                <ul class="bg-gray-100 px-8 py-8">
                    <li class="mb-6">
                        <a href="#" class="flex lg:items-center group" @keydown.esc.exact="hideMenu"
                            @keydown.tab.exact="focusNext(false)" @keydown.shift.tab="focusPrevious(false)"
                            @keydown.up.exact.prevent="focusPrevious(true)"
                            @keydown.down.exact.prevent="focusNext(true)">
                            <svg fill="currentColor" class="text-blue-500 group-hover:text-blue-800"
                            ...
                            <span class="flex flex-col lg:flex-row lg:items-center">
                                <span
                                    class="block ml-2 font-bold text-blue-800 group-hover:text-blue-800">Documentation</span>
                                <span class="block ml-2 lg:ml-4 text-sm text-gray-600 group-hover:text-blue-800">Start
                                    integrating products and tools</span>
                            </span>
                        </a>
                    </li>
                    <li class="mb-6">
                        <a href="#" class="flex lg:items-center group" @keydown.esc.exact="hideMenu"
                            ...
                            @keydown.up.exact.prevent="focusPrevious(true)"
                            @keydown.down.exact.prevent="focusNext(true)">
                            <svg fill="currentColor" class="text-blue-500 group-hover:text-blue-800" width="24"
                                height="24">
                                <path class="heroicon-ui"
                            ...
                            <span class="flex flex-col lg:flex-row lg:items-center">
                                <span class="block ml-2 font-bold text-blue-800 group-hover:text-blue-800">Full API
                                    Reference</span>
                                <span
                                    class="block ml-2 lg:ml-4 text-sm text-gray-600 group-hover:text-blue-800">Official
                                    libraries for our API</span>
                            </span>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="flex lg:items-center group" @keydown.esc.exact="hideMenu"
                            @keydown.tab.exact="hideMenu" @keydown.shift.tab="focusPrevious(false)"
                            @keydown.up.exact.prevent="focusPrevious(true)" @keydown.down.exact.prevent="">
                            <svg fill="currentColor" class="text-blue-500 group-hover:text-blue-800"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24">
                                <path class="heroicon-ui"
                            ...
                            <span class="flex flex-col lg:flex-row lg:items-center">
                                <span class="block ml-2 font-bold text-blue-800 group-hover:text-blue-800">Open
                                    Source</span>
                                <span class="block ml-2 lg:ml-4 text-sm text-gray-600 group-hover:text-blue-800">Giving
                                    back to the community</span>
                            </span>
                        </a>
                    </li>
                </ul>
